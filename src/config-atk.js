...
const CONFIG = {
  ...
  AGENTS: {
    pedro: {
      ...
      get media()    { return { foto1: env('PEDRO_FOTO1'), video1: env('PEDRO_VIDEO1'), audio1: env('PEDRO_AUDIO1') }; },
      pauseCmd:  'PEDRO_PARA',
    ...
    rodrigo: {
      ...
      get media()    { return { foto1: env('RODRIGO_FOTO1'), video1: env('RODRIGO_VIDEO1'), audio1: env('RODRIGO_AUDIO1') }; },
